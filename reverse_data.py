...
close_y = []
date_x = []
for item in list(reversed(API_DATA["data"])):
...
# print(type(API_DATA["data"]))
# print(type(reversed(API_DATA["data"])))
# reversed_API_DATA = reversed(API_DATA["data"])
# print(type(reversed_API_DATA))
# reversed_API_DATA=list(reversed_API_DATA)
# print(type(reversed_API_DATA))
